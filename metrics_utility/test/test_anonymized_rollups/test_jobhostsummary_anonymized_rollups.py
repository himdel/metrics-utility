...
def test_jobhostsummary_anonymized():
    ...
    result = jobhostsummary_anonymized_rollup.prepare(df)
    ...
    assert job_type_data['failed_total'] == 2  # T1: 2 failures
    ...
    assert workflowjob_type_data['failed_total'] == 4  # T2: 4 failures
